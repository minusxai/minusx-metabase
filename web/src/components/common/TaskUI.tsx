    ...
    >
      ...
      <VStack alignItems={"stretch"}>
        ...
        <HStack flexWrap={"wrap"} gap={1}>
          ...
          <Button size="xs" leftIcon={<BiEdit size={14}/>} colorScheme="minusxGreen" variant="solid" onClick={()=>openDevtoolTab("Custom Instructions")}>Custom Instructions</Button>
          { currentTool == 'metabase' && configs.IS_DEV && false && <Button size="xs" leftIcon={<BiTrash size={14}/>} colorScheme="minusxGreen" variant="solid" onClick={clearSQL}>Clear SQL</Button> }
