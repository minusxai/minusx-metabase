...
6. If you estimate that the task can be accomplished with the tool calls selected in the current call, include the markTaskDone tool call at the end. Do not wait for everything to be executed.
7. If you are waiting for the user's clarification, also mark the task as done.
